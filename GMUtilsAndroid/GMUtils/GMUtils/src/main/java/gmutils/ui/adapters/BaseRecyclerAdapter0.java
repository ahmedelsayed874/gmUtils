...
public abstract class BaseRecyclerAdapter0<T> extends RecyclerView.Adapter<BaseRecyclerAdapter0<T>.ViewHolder> {
    ...
    public void enableDeleteItemOnSwipe(ActionCallback<Value3<BaseRecyclerAdapter0<T>, T, Integer>, Boolean> onDelete) {
            ...
            ItemTouchHelper touchHelper = new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(
                ...
                public void onSwiped(@NotNull RecyclerView.ViewHolder viewHolder, int direction) {
                    ...
                    if (onDelete == null) {
                        ...
                        try {
                            boolean delete = onDelete.invoke(new Value3<>(BaseRecyclerAdapter0.this, getItem(position), position));
