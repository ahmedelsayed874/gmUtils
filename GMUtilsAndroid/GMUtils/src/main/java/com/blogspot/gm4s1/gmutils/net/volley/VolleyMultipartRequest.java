package com.blogspot.gm4s1.gmutils.net.volley;
...
class VolleyMultipartRequestExample {
    ...
    private void uploadBitmap(Context context, String url, final Bitmap bitmap, final String tags) {
