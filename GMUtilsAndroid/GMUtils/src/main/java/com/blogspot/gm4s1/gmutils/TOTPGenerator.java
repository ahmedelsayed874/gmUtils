...
//            }
    ...
    fun generateQRCode(
        ...
        return generateQRCode(textForEncoding = data.uri, QRType= QRType)
    }

    fun generateQRCode(textForEncoding: String, QRType: BarcodeFormat): Bitmap {
        val qrGen = QRGen()
        return qrGen.generate(textForEncoding, QRType)
    }
...
public class QRGen {
    ...
    private val imageSize = 350
    private var qrBitmap: Bitmap? = null
    private var barcodeBitmap: Bitmap? = null

    fun generate(data: QrData, type: BarcodeFormat): Bitmap {
        return generate(data.uri, type)
    }

    fun generate(data: String, type: BarcodeFormat): Bitmap {
